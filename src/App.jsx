...
const App = () => {
  ...
  return (
    <div className="min-h-screen bg-pink-50 p-4">
      <div className="max-w-md mx-auto">
        <h2 className="text-2xl font-bold text-pink-800 mb-6">Tela em Desenvolvimento</h2>
        <p className="text-center text-gray-600 mb-8">Esta funcionalidade será implementada em breve!</p>
        <button
          onClick={() => setCurrentScreen('home')}
